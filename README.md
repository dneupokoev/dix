...
- **Логирование** — вывод сообщений с меткой времени и уровнем важности
- **Печать** — форматированный вывод с временными метками
- **Запись CSV** — сохранение данных в CSV-файлы с поддержкой кодировки Windows-1251 и сжатия
- **Выполнение с таймаутом** — выполнение R-выражений с ограничением по времени и автоматическими повторными попытками
- **XMPP-сообщения** — отправка уведомлений в XMPP-конференции через REST API Prosody
...
Dmitry Neupokoev <dneupokoev@example.com>
